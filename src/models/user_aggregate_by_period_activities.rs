...
/// UserAggregateByPeriodActivities : A list, in which each item contains details of one user's activities.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserAggregateByPeriodActivities {
    ...
    #[serde(rename = "userAggregateActivity", skip_serializing_if = "Option::is_none")]
    pub user_aggregate_activity: Option<Vec<models::AggregateActivityWithDates>>,
}

impl UserAggregateByPeriodActivities {
    /// A list, in which each item contains details of one user's activities.
    pub fn new() -> UserAggregateByPeriodActivities {
        UserAggregateByPeriodActivities {
            user_id: None,
            user_email_address: None,
            user_aggregate_activity: None,
        }
    }
}
