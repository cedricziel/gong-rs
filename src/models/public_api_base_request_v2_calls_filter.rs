...
pub struct PublicApiBaseRequestV2CallsFilter {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<models::CallsFilter>,
}

impl PublicApiBaseRequestV2CallsFilter {
    pub fn new(filter: models::CallsFilter) -> PublicApiBaseRequestV2CallsFilter {
