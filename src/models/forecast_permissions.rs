...
/// ForecastPermissions : All forecast permissions.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ForecastPermissions {
    #[serde(rename = "forecastAccess", skip_serializing_if = "Option::is_none")]
    pub forecast_access: Option<Box<models::ForecastAccess>>,
    #[serde(rename = "forecastEditSubmissions", skip_serializing_if = "Option::is_none")]
    pub forecast_edit_submissions: Option<Box<models::ForecastEditSubmissions>>,
    #[serde(rename = "forecastEditTargets", skip_serializing_if = "Option::is_none")]
    pub forecast_edit_targets: Option<Box<models::ForecastEditTargets>>,
}

impl ForecastPermissions {
    /// All forecast permissions.
    pub fn new() -> ForecastPermissions {
        ForecastPermissions {
            forecast_access: None,
            forecast_edit_submissions: None,
            forecast_edit_targets: None,
        }
    }
}
