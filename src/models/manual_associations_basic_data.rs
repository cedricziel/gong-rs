...
/// ManualAssociationsBasicData : Basic association details such as call Id, etc.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ManualAssociationsBasicData {
    ...
    #[serde(rename = "associatedCrmObjects", skip_serializing_if = "Option::is_none")]
    pub associated_crm_objects: Option<Vec<models::AssociationObject>>,
}

impl ManualAssociationsBasicData {
    /// Basic association details such as call Id, etc.
    pub fn new() -> ManualAssociationsBasicData {
        ManualAssociationsBasicData {
            call_id: None,
            user_id: None,
            created: None,
            associated_crm_objects: None,
        }
    }
}
