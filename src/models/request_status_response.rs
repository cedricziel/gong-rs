...
pub struct RequestStatusResponse {
    ...
    pub errors: Option<Vec<models::LineErrorResponse>>,
    /// Number of objects that failed parsing
    #[serde(rename = "totalErrorCount", skip_serializing_if = "Option::is_none")]
    pub total_error_count: Option<i32>,
    /// Number of valid objects
    #[serde(rename = "totalSuccessCount", skip_serializing_if = "Option::is_none")]
    pub total_success_count: Option<i32>,
}

impl RequestStatusResponse {
    pub fn new() -> RequestStatusResponse {
