...
/// GenericProperty : A list of additional properties for the event
...
impl GenericProperty {
    ...
    pub fn new(name: String, value: String, data_type: DataType) -> GenericProperty {
        GenericProperty {
            name,
            value,
            data_type,
...
pub enum DataType {
    #[serde(rename = "number, string, url, date")]
    NumberCommaStringCommaUrlCommaDate,
}

impl Default for DataType {
    fn default() -> DataType {
        Self::NumberCommaStringCommaUrlCommaDate
    }
}
