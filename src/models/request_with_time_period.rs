...
pub struct RequestWithTimePeriod {
...
impl RequestWithTimePeriod {
    pub fn new(filter: models::MultipleUsersWithDates, aggregation_period: AggregationPeriod) -> RequestWithTimePeriod {
