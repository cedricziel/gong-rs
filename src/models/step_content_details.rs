...
/// StepContentDetails : For content where there are a number of steps to complete in the content, such as shipment tracking or course advancement
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct StepContentDetails {
    /// The current step the person is in, in the process
    #[serde(rename = "value")]
    pub value: String,
    /// A list of all available steps in the process
    #[serde(rename = "availableSteps")]
    pub available_steps: Vec<String>,
}

impl StepContentDetails {
    /// For content where there are a number of steps to complete in the content, such as shipment tracking or course advancement
    pub fn new(value: String, available_steps: Vec<String>) -> StepContentDetails {
        StepContentDetails {
            value,
            available_steps,
        }
