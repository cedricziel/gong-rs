...
pub struct PhoneNumberReferences {
    ...
    pub customer_data: Option<Vec<models::CustomerData>>,
    /// The supplied phone number.
    #[serde(rename = "suppliedPhoneNumber", skip_serializing_if = "Option::is_none")]
    pub supplied_phone_number: Option<String>,
    /// Matching phone numbers found.
    #[serde(rename = "matchingPhoneNumbers", skip_serializing_if = "Option::is_none")]
    pub matching_phone_numbers: Option<Vec<String>>,
    /// Related email addresses.
    #[serde(rename = "emailAddresses", skip_serializing_if = "Option::is_none")]
    pub email_addresses: Option<Vec<String>>,
}

impl PhoneNumberReferences {
    pub fn new() -> PhoneNumberReferences {
        PhoneNumberReferences {
            ...
            meetings: None,
            customer_data: None,
            supplied_phone_number: None,
            matching_phone_numbers: None,
