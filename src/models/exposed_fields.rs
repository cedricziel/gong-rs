...
/// ExposedFields : The exposed fields identifies which field, if any, are returned in the response object
...
pub struct ExposedFields {
    ...
    pub content: Option<Box<models::CallContent>>,
    #[serde(rename = "interaction", skip_serializing_if = "Option::is_none")]
    pub interaction: Option<Box<models::CallInteraction>>,
    #[serde(rename = "collaboration", skip_serializing_if = "Option::is_none")]
    pub collaboration: Option<Box<models::CallCollaboration>>,
