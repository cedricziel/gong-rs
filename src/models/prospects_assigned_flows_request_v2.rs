...
/// ProspectsAssignedFlowsRequestV2 : Prospects assigned flows request
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ProspectsAssignedFlowsRequestV2 {
    /// The CRM IDs of the prospects to list assigned flows for
    #[serde(rename = "crmProspectsIds")]
    pub crm_prospects_ids: Vec<String>,
}

impl ProspectsAssignedFlowsRequestV2 {
    /// Prospects assigned flows request
    pub fn new(crm_prospects_ids: Vec<String>) -> ProspectsAssignedFlowsRequestV2 {
