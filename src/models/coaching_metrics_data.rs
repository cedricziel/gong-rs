...
/// CoachingMetricsData : A list, in which each item specifies one managers coaching data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CoachingMetricsData {
    #[serde(rename = "manager", skip_serializing_if = "Option::is_none")]
    pub manager: Option<Box<models::CoachingUser>>,
    #[serde(rename = "directReportsMetrics", skip_serializing_if = "Option::is_none")]
    pub direct_reports_metrics: Option<Vec<models::CoachingRepData>>,
}

impl CoachingMetricsData {
    /// A list, in which each item specifies one managers coaching data
    pub fn new() -> CoachingMetricsData {
        CoachingMetricsData {
            manager: None,
            direct_reports_metrics: None,
        }
    }
}
