...
pub struct PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<models::MultipleUsersRequestWithCreationDates>,
}

impl PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates {
    pub fn new(filter: models::MultipleUsersRequestWithCreationDates) -> PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates {
