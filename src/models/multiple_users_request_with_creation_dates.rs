...
pub struct MultipleUsersRequestWithCreationDates {
    ...
    #[serde(rename = "createdFromDateTime", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "createdToDateTime", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "includeAvatars", skip_serializing_if = "Option::is_none")]
...
impl MultipleUsersRequestWithCreationDates {
    ...
    pub fn new() -> MultipleUsersRequestWithCreationDates {
        MultipleUsersRequestWithCreationDates {
            created_from_date_time: None,
            created_to_date_time: None,
            include_avatars: None,
            user_ids: None,
        }
    }
}
