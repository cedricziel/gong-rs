...
pub struct PermissionProfileUsersResponse {
    ...
    pub users: Option<Vec<models::UserSimpleMetadata>>,
}

impl PermissionProfileUsersResponse {
    pub fn new() -> PermissionProfileUsersResponse {
