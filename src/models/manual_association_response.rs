...
pub struct ManualAssociationResponse {
    ...
    pub associations: Option<Vec<models::ManualAssociationsBasicData>>,
}

impl ManualAssociationResponse {
    pub fn new() -> ManualAssociationResponse {
