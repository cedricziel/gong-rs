...
/// CallUsersAccessDto : Call users access
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CallUsersAccessDto {
...
impl CallUsersAccessDto {
    /// Call users access
    pub fn new(call_id: String, user_ids: Vec<String>) -> CallUsersAccessDto {
        CallUsersAccessDto {
            call_id,
            user_ids,
        }
