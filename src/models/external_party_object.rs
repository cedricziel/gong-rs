...
/// ExternalPartyObject : External Object
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ExternalPartyObject {
    ...
    pub fields: Option<Vec<models::PartyContextField>>,
    /// Timing of object
    #[serde(rename = "timing", skip_serializing_if = "Option::is_none")]
    pub timing: Option<Timing>,
}

impl ExternalPartyObject {
    /// External Object
    pub fn new() -> ExternalPartyObject {
        ExternalPartyObject {
            object_type: None,
            object_id: None,
            fields: None,
