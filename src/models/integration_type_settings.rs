...
/// IntegrationTypeSettings : Set a list of dynamic origins for a company
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IntegrationTypeSettings {
...
impl IntegrationTypeSettings {
    /// Set a list of dynamic origins for a company
    pub fn new(integration_type: IntegrationType, allowed_origin: String) -> IntegrationTypeSettings {
...
pub enum IntegrationType {
    #[serde(rename = "EMAIL_COMPOSER")]
    EmailComposer,
    #[serde(rename = "ACCOUNT_PAGES")]
    AccountPages,
    #[serde(rename = "DIALER")]
    Dialer,
}
