...
/// UserSimpleMetadata : A list, in which each item specifies a user attached to the permission profile.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserSimpleMetadata {
