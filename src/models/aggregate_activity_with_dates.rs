...
/// AggregateActivityWithDates : Aggregated activity for a user within a time period
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AggregateActivityWithDates {
...
impl AggregateActivityWithDates {
    /// Aggregated activity for a user within a time period
    pub fn new() -> AggregateActivityWithDates {
