...
/// Content : The content the person looked at
...
pub struct Content {
    ...
    #[serde(rename = "contentLabel", skip_serializing_if = "Option::is_none")]
    pub content_label: Option<Vec<String>>,
    ...
    #[serde(rename = "contentAdditionalInfoUrl", skip_serializing_if = "Option::is_none")]
    pub content_additional_info_url: Option<String>,
    #[serde(rename = "numericContentDetails", skip_serializing_if = "Option::is_none")]
    pub numeric_content_details: Option<Box<models::NumericContentDetails>>,
    #[serde(rename = "stepContentDetails", skip_serializing_if = "Option::is_none")]
    pub step_content_details: Option<Box<models::StepContentDetails>>,
    #[serde(rename = "searchObjectDetails", skip_serializing_if = "Option::is_none")]
    pub search_object_details: Option<Box<models::SearchObjectDetails>>,
    /// Include additional custom data about the content
    #[serde(rename = "contentCustomFields", skip_serializing_if = "Option::is_none")]
    pub content_custom_fields: Option<Vec<models::CustomField>>,
}

impl Content {
    /// The content the person looked at
    pub fn new(content_title: String) -> Content {
        Content {
            content_id: None,
            content_title,
            content_label: None,
            content_url: None,
            content_additional_info_url: None,
            numeric_content_details: None,
            step_content_details: None,
            search_object_details: None,
            content_custom_fields: None,
        }
    }
}
