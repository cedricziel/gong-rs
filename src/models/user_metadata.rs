...
pub struct UserMetadata {
    ...
    #[serde(rename = "emailAliases", skip_serializing_if = "Option::is_none")]
    pub email_aliases: Option<Vec<String>>,
    /// The trusted authentication email assigned to the Gong user
    #[serde(rename = "trustedEmailAddress", skip_serializing_if = "Option::is_none")]
    pub trusted_email_address: Option<String>,
    ...
    #[serde(rename = "personalMeetingUrls", skip_serializing_if = "Option::is_none")]
    pub personal_meeting_urls: Option<Vec<String>>,
    ...
    #[serde(rename = "meetingConsentPageUrl", skip_serializing_if = "Option::is_none")]
    pub meeting_consent_page_url: Option<String>,
...
impl UserMetadata {
    ...
    pub fn new() -> UserMetadata {
        UserMetadata {
            ...
            active: None,
            email_aliases: None,
            trusted_email_address: None,
            first_name: None,
            last_name: None,
            title: None,
            phone_number: None,
            extension: None,
            personal_meeting_urls: None,
            settings: None,
            manager_id: None,
            meeting_consent_page_url: None,
