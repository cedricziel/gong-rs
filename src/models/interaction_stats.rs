...
/// InteractionStats : A list of interaction statistics. Applicable values: 'Longest Monologue', 'Longest Customer Story', 'Interactivity', 'Patience', 'Question Rate'.
...
pub struct InteractionStats {
    ...
    #[serde(rename = "personInteractionStats", skip_serializing_if = "Option::is_none")]
    pub person_interaction_stats: Option<Vec<models::InteractionStat>>,
}
...
impl InteractionStats {
    ...
    pub fn new() -> InteractionStats {
        InteractionStats {
            user_id: None,
            user_email_address: None,
            person_interaction_stats: None,
        }
    }
}
