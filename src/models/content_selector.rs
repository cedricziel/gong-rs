...
/// ContentSelector : The content selector identifies which data components, if any, are needed, by the caller
...
pub struct ContentSelector {
    ...
    #[serde(rename = "contextTiming", skip_serializing_if = "Option::is_none")]
    pub context_timing: Option<Vec<ContextTiming>>,
    #[serde(rename = "exposedFields", skip_serializing_if = "Option::is_none")]
    pub exposed_fields: Option<Box<models::ExposedFields>>,
}
...
/// Timing for the context data. The field is optional and can contain either \"Now\" or \"TimeOfCall\" or both. The default value is [\"Now\"]. Can be provided only when the context field is set to 'Extended'
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ContextTiming {
    #[serde(rename = "Now")]
    Now,
    #[serde(rename = "TimeOfCall")]
    TimeOfCall,
}

impl Default for ContextTiming {
    fn default() -> ContextTiming {
        Self::Now
    }
}
