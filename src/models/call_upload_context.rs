...
/// CallUploadContext : Links to external systems such as CRM, Telephony System, Case Management etc. Currently only Salesforce and Generic are supported.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CallUploadContext {
    ...
    pub objects: Option<Vec<models::ExternalCrmCallObject>>,
}

impl CallUploadContext {
    ...
    pub fn new(system: System) -> CallUploadContext {
        CallUploadContext {
            system,
            objects: None,
        }
