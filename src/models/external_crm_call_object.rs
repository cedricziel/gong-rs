...
/// ExternalCrmCallObject : External object associated with the call
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ExternalCrmCallObject {
    ...
    pub fields: Option<Vec<models::ContextField>>,
}

impl ExternalCrmCallObject {
    /// External object associated with the call
    pub fn new(object_type: ObjectType, object_id: String) -> ExternalCrmCallObject {
...
pub enum ObjectType {
    ...
    #[serde(rename = "User")]
    User,
    #[serde(rename = "Opportunity,Account")]
    OpportunityCommaAccount,
}
