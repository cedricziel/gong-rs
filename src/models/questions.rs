...
pub struct Questions {
    ...
    #[serde(rename = "companyCount", skip_serializing_if = "Option::is_none")]
    pub company_count: Option<i32>,
    /// The number of questions asked by non-company speakers.
    #[serde(rename = "nonCompanyCount", skip_serializing_if = "Option::is_none")]
    pub non_company_count: Option<i32>,
}
