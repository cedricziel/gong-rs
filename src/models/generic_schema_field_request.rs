...
/// GenericSchemaFieldRequest : selectedFields
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GenericSchemaFieldRequest {
    ...
    #[serde(rename = "referenceTo", skip_serializing_if = "Option::is_none")]
    pub reference_to: Option<String>,
    /// The list of values for the field. Required for PICKLIST fields
    #[serde(rename = "orderedValueList", skip_serializing_if = "Option::is_none")]
    pub ordered_value_list: Option<Vec<String>>,
}

impl GenericSchemaFieldRequest {
    /// selectedFields
    pub fn new(unique_name: String, label: String, r#type: Type) -> GenericSchemaFieldRequest {
