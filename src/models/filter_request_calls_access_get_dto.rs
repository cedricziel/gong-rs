...
pub struct FilterRequestCallsAccessGetDto {
    #[serde(rename = "filter")]
    pub filter: Box<models::CallsAccessGetDto>,
}

impl FilterRequestCallsAccessGetDto {
    pub fn new(filter: models::CallsAccessGetDto) -> FilterRequestCallsAccessGetDto {
