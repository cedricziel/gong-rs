...
pub struct SettingsHistory {
    ...
    #[serde(rename = "userSettingsHistory", skip_serializing_if = "Option::is_none")]
    pub user_settings_history: Option<Vec<models::UserSettingsHistory>>,
}

impl SettingsHistory {
    pub fn new() -> SettingsHistory {
        SettingsHistory {
            request_id: None,
            user_settings_history: None,
        }
    }
}
