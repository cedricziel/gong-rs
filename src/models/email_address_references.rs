...
pub struct EmailAddressReferences {
    ...
    #[serde(rename = "customerEngagement", skip_serializing_if = "Option::is_none")]
    pub customer_engagement: Option<Vec<models::CustomerEngagement>>,
}

impl EmailAddressReferences {
    pub fn new() -> EmailAddressReferences {
