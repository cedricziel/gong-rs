...
pub struct AnsweredScorecards {
    ...
    #[serde(rename = "answeredScorecards", skip_serializing_if = "Option::is_none")]
    pub answered_scorecards: Option<Vec<models::AnsweredScorecard>>,
}

impl AnsweredScorecards {
    pub fn new() -> AnsweredScorecards {
        AnsweredScorecards {
            request_id: None,
            records: None,
            answered_scorecards: None,
        }
    }
}
