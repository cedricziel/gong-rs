...
/// ContentDto : Analysis of the interaction content.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContentDto {
    /// A list of the agenda of each part of the call.
    #[serde(rename = "structure", skip_serializing_if = "Option::is_none")]
    pub structure: Option<Vec<models::StructureDto>>,
    #[serde(rename = "trackers", skip_serializing_if = "Option::is_none")]
    pub trackers: Option<Vec<models::TrackerDto>>,
    #[serde(rename = "topics", skip_serializing_if = "Option::is_none")]
    pub topics: Option<Vec<models::TopicDto>>,
    #[serde(rename = "pointsOfInterest", skip_serializing_if = "Option::is_none")]
    pub points_of_interest: Option<Box<models::PointsOfInterest>>,
    ...
    pub outline: Option<Vec<models::CallOutlineSection>>,
    ...
    pub highlights: Option<Vec<models::CallHighlightsSection>>,
    #[serde(rename = "callOutcome", skip_serializing_if = "Option::is_none")]
    pub call_outcome: Option<Box<models::CallOutcome>>,
    ...
    pub key_points: Option<Vec<models::CallKeyPoint>>,
}

impl ContentDto {
    /// Analysis of the interaction content.
    pub fn new() -> ContentDto {
        ContentDto {
            structure: None,
            trackers: None,
            topics: None,
