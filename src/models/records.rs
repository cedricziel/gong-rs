...
/// Records : Information about the number of records that match the requested filter.
...
pub struct Records {
    ...
    #[serde(rename = "currentPageSize", skip_serializing_if = "Option::is_none")]
    pub current_page_size: Option<i32>,
    /// Current page number.
    #[serde(rename = "currentPageNumber", skip_serializing_if = "Option::is_none")]
    pub current_page_number: Option<i32>,
