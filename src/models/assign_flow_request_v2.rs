...
/// AssignFlowRequestV2 : Flow assignment parameters.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssignFlowRequestV2 {
    /// The CRM IDs of the contact or lead that should be assigned to a flow
    #[serde(rename = "crmProspectsIds")]
    pub crm_prospects_ids: Vec<String>,
    /// The Engage Flow ID to assign the contacts to.
    #[serde(rename = "flowId")]
    pub flow_id: String,
    /// The email of the Gong user who owns the flow to-dos.
    #[serde(rename = "flowInstanceOwnerEmail")]
    pub flow_instance_owner_email: String,
}

impl AssignFlowRequestV2 {
    /// Flow assignment parameters.
    pub fn new(crm_prospects_ids: Vec<String>, flow_id: String, flow_instance_owner_email: String) -> AssignFlowRequestV2 {
        AssignFlowRequestV2 {
            crm_prospects_ids,
            flow_id,
