...
/// PointsOfInterest : Points of interest of the call.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PointsOfInterest {
    #[serde(rename = "actionItems", skip_serializing_if = "Option::is_none")]
    pub action_items: Option<Vec<models::PointOfInterest>>,
}
