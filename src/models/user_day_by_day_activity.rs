...
/// UserDayByDayActivity : A list, in which each item contains one user's activity.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserDayByDayActivity {
    ...
    #[serde(rename = "userDailyActivityStats", skip_serializing_if = "Option::is_none")]
    pub user_daily_activity_stats: Option<Vec<models::DailyActivityWithDates>>,
}

impl UserDayByDayActivity {
    /// A list, in which each item contains one user's activity.
    pub fn new() -> UserDayByDayActivity {
        UserDayByDayActivity {
            user_id: None,
            user_email_address: None,
            user_daily_activity_stats: None,
        }
    }
}
