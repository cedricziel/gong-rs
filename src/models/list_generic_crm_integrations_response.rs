...
pub struct ListGenericCrmIntegrationsResponse {
    ...
    pub integrations: Option<Vec<models::GenericCrmIntegration>>,
}

impl ListGenericCrmIntegrationsResponse {
    pub fn new() -> ListGenericCrmIntegrationsResponse {
