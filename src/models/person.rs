...
/// Person : The person who did the event
...
pub struct Person {
    ...
    #[serde(rename = "personBusinessContext", skip_serializing_if = "Option::is_none")]
    pub person_business_context: Option<Box<models::PersonBusinessContext>>,
    ...
    #[serde(rename = "personCustomFields", skip_serializing_if = "Option::is_none")]
    pub person_custom_fields: Option<Vec<models::CustomField>>,
}
...
impl Person {
    ...
    pub fn new() -> Person {
        Person {
            ...
            phone_number: None,
            person_id: None,
            person_business_context: None,
            location: None,
            company: None,
            person_custom_fields: None,
        }
    }
}
