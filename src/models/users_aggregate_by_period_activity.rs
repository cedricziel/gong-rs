...
pub struct UsersAggregateByPeriodActivity {
    ...
    #[serde(rename = "usersAggregateActivity", skip_serializing_if = "Option::is_none")]
    pub users_aggregate_activity: Option<Vec<models::UserAggregateByPeriodActivities>>,
}

impl UsersAggregateByPeriodActivity {
    pub fn new() -> UsersAggregateByPeriodActivity {
        UsersAggregateByPeriodActivity {
            request_id: None,
            records: None,
            users_aggregate_activity: None,
        }
    }
}
