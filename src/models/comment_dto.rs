...
pub struct CommentDto {
    ...
    #[serde(rename = "audioStartTime", skip_serializing_if = "Option::is_none")]
    pub audio_start_time: Option<f32>,
    /// The number of seconds from the beginning of the call that the comment ends refers to.
    #[serde(rename = "audioEndTime", skip_serializing_if = "Option::is_none")]
    pub audio_end_time: Option<f32>,
    /// Unique identifier of the user who wrote the comment.
    #[serde(rename = "commenterUserId", skip_serializing_if = "Option::is_none")]
    pub commenter_user_id: Option<String>,
    ...
    #[serde(rename = "duringCall", skip_serializing_if = "Option::is_none")]
    pub during_call: Option<bool>,
}
