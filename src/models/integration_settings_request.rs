...
/// IntegrationSettingsRequest : Integration settings metadata
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IntegrationSettingsRequest {
    /// Set a list of dynamic origins for a company
    #[serde(rename = "integrationTypeSettings")]
    pub integration_type_settings: Vec<models::IntegrationTypeSettings>,
}

impl IntegrationSettingsRequest {
    /// Integration settings metadata
    pub fn new(integration_type_settings: Vec<models::IntegrationTypeSettings>) -> IntegrationSettingsRequest {
        IntegrationSettingsRequest {
            integration_type_settings,
        }
    }
}
