...
/// InsightsAccessWithPermissionLevel : Insights access permission.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InsightsAccessWithPermissionLevel {
    ...
    #[serde(rename = "teamLeadIds", skip_serializing_if = "Option::is_none")]
    pub team_lead_ids: Option<Vec<String>>,
}

impl InsightsAccessWithPermissionLevel {
    /// Insights access permission.
    pub fn new() -> InsightsAccessWithPermissionLevel {
...
pub enum PermissionLevel {
    #[serde(rename = "all")]
    All,
    #[serde(rename = "managers-team")]
    ManagersTeam,
    #[serde(rename = "report-to-them")]
    ReportToThem,
    #[serde(rename = "own")]
    Own,
    #[serde(rename = "none")]
    None,
    #[serde(rename = "all / managers-team / report-to-them / own / none")]
    AllSlashManagersTeamSlashReportToThemSlashOwnSlashNone,
}
