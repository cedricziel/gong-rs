...
/// CallsRequestFilterWithOwners : Filter parameters.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CallsRequestFilterWithOwners {
    ...
    #[serde(rename = "primaryUserIds", skip_serializing_if = "Option::is_none")]
    pub primary_user_ids: Option<Vec<String>>,
}

impl CallsRequestFilterWithOwners {
    /// Filter parameters.
    pub fn new() -> CallsRequestFilterWithOwners {
