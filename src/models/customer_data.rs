...
/// CustomerData : A list of links to data from external systems (such as CRM, Telephony System, Case Management, etc.) that reference the email address and that Gong stores.
...
pub struct CustomerData {
    ...
    pub objects: Option<Vec<models::CustomerDataObject>>,
}
