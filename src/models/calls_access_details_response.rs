...
pub struct CallsAccessDetailsResponse {
    /// A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
    #[serde(rename = "requestId", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    /// A list, in which each item specifies a call & users with access to this call.
    #[serde(rename = "callAccessList", skip_serializing_if = "Option::is_none")]
    pub call_access_list: Option<Vec<models::CallAccessDetails>>,
}

impl CallsAccessDetailsResponse {
    pub fn new() -> CallsAccessDetailsResponse {
        CallsAccessDetailsResponse {
            request_id: None,
            call_access_list: None,
        }
    }
}
