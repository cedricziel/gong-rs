...
/// InteractionMeasuresDto : Metrics collected around the interaction during the call.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InteractionMeasuresDto {
    /// A list of the talk duration per speaker.
    #[serde(rename = "speakers", skip_serializing_if = "Option::is_none")]
    pub speakers: Option<Vec<models::UserSpeaker>>,
    ...
    #[serde(rename = "interactionStats", skip_serializing_if = "Option::is_none")]
    pub interaction_stats: Option<Vec<models::InteractionStatsDto>>,
    /// A list of video statistics about what's presented and for how long.
    #[serde(rename = "video", skip_serializing_if = "Option::is_none")]
    pub video: Option<Vec<models::VideoInteractionDto>>,
    #[serde(rename = "questions", skip_serializing_if = "Option::is_none")]
    pub questions: Option<Box<models::Questions>>,
}

impl InteractionMeasuresDto {
    /// Metrics collected around the interaction during the call.
    pub fn new() -> InteractionMeasuresDto {
