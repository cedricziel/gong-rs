...
pub struct CoachingRepData {
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Box<models::CoachingUser>>,
    #[serde(rename = "metrics", skip_serializing_if = "Option::is_none")]
    pub metrics: Option<std::collections::HashMap<String, Vec<String>>>,
}

impl CoachingRepData {
    pub fn new() -> CoachingRepData {
        CoachingRepData {
            report: None,
            metrics: None,
        }
