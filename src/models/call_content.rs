...
/// CallContent : The content of the call
...
pub struct CallContent {
    ...
    #[serde(rename = "trackerOccurrences", skip_serializing_if = "Option::is_none")]
    pub tracker_occurrences: Option<bool>,
