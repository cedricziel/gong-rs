...
pub struct AssignFlowResponse {
    /// A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
    #[serde(rename = "requestId", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "prospectsAssigned", skip_serializing_if = "Option::is_none")]
    pub prospects_assigned: Option<Vec<models::PublicApiAssignedFlow>>,
    #[serde(rename = "prospectsNotAssigned", skip_serializing_if = "Option::is_none")]
    pub prospects_not_assigned: Option<Vec<models::AssignedFlowFailure>>,
}

impl AssignFlowResponse {
    pub fn new() -> AssignFlowResponse {
        AssignFlowResponse {
            request_id: None,
            prospects_assigned: None,
            prospects_not_assigned: None,
        }
    }
}
