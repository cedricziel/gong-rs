...
/// AssociationObject : List of all association objects.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssociationObject {
    /// CRM account Id.
    #[serde(rename = "accountCrmId", skip_serializing_if = "Option::is_none")]
    pub account_crm_id: Option<String>,
    /// CRM deal Id, if deal/opportunity was associated.
    #[serde(rename = "dealCrmId", skip_serializing_if = "Option::is_none")]
    pub deal_crm_id: Option<String>,
}

impl AssociationObject {
    /// List of all association objects.
    pub fn new() -> AssociationObject {
        AssociationObject {
            account_crm_id: None,
            deal_crm_id: None,
        }
