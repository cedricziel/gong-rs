...
/// ContentSharedEvent : Content Shared Event
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContentSharedEvent {
    ...
    #[serde(rename = "shareInfoUrl", skip_serializing_if = "Option::is_none")]
    pub share_info_url: Option<String>,
    ...
    pub recipients: Option<Vec<models::Actor>>,
...
impl ContentSharedEvent {
    /// Content Shared Event
    pub fn new(reporting_system: String, event_timestamp: String, content_id: String, content_url: String, content_title: String) -> ContentSharedEvent {
        ContentSharedEvent {
            reporting_system,
            event_timestamp,
            event_id: None,
