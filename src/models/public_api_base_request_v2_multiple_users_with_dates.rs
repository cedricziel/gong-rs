...
pub struct PublicApiBaseRequestV2MultipleUsersWithDates {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<models::MultipleUsersWithDates>,
}

impl PublicApiBaseRequestV2MultipleUsersWithDates {
    pub fn new(filter: models::MultipleUsersWithDates) -> PublicApiBaseRequestV2MultipleUsersWithDates {
