...
pub struct PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<models::CallsRequestFilterWithOwners>,
    #[serde(rename = "contentSelector", skip_serializing_if = "Option::is_none")]
    pub content_selector: Option<Box<models::ContentSelector>>,
}

impl PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector {
    pub fn new(filter: models::CallsRequestFilterWithOwners) -> PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector {
