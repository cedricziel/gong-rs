...
pub struct PointOfInterest {
    ...
    #[serde(rename = "snippetStartTime", skip_serializing_if = "Option::is_none")]
    pub snippet_start_time: Option<f64>,
    /// The number of seconds from the beginning of the call that the snippet end refers to.
    #[serde(rename = "snippetEndTime", skip_serializing_if = "Option::is_none")]
    pub snippet_end_time: Option<f64>,
...
impl PointOfInterest {
    pub fn new() -> PointOfInterest {
        PointOfInterest {
            snippet_start_time: None,
            snippet_end_time: None,
            speaker_id: None,
            snippet: None,
        }
    }
