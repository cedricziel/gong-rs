...
/// CustomerEngagement : A list of customer's engagement (such as viewing external share call)
...
pub struct CustomerEngagement {
    ...
    #[serde(rename = "reportingSystem", skip_serializing_if = "Option::is_none")]
...
pub enum EventType {
    #[serde(rename = "contentShared")]
    ContentShared,
    #[serde(rename = "contentViewed")]
    ContentViewed,
    #[serde(rename = "customEvent")]
    CustomEvent,
    #[serde(rename = "digitalInteraction")]
    DigitalInteraction,
}
