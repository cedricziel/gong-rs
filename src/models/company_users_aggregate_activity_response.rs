...
pub struct CompanyUsersAggregateActivityResponse {
    /// A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
    #[serde(rename = "requestId", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "records", skip_serializing_if = "Option::is_none")]
    pub records: Option<Box<models::Records>>,
    /// A list, in which each item specifies one user's activities.
    #[serde(rename = "usersAggregateActivityStats", skip_serializing_if = "Option::is_none")]
    pub users_aggregate_activity_stats: Option<Vec<models::UserActivity>>,
...
impl CompanyUsersAggregateActivityResponse {
    pub fn new() -> CompanyUsersAggregateActivityResponse {
        CompanyUsersAggregateActivityResponse {
            request_id: None,
            records: None,
            users_aggregate_activity_stats: None,
            time_zone: None,
            to_date_time: None,
            from_date_time: None,
        }
