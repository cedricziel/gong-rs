...
/// PartyUploadContext : Links to external systems such as CRM, Telephony System, Case Management etc. Currently only Salesforce and Generic are supported.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PartyUploadContext {
    ...
    pub objects: Option<Vec<models::ExternalCrmPartyObject>>,
}

impl PartyUploadContext {
    ...
    pub fn new(system: System) -> PartyUploadContext {
        PartyUploadContext {
            system,
            objects: None,
        }
