...
pub struct DailyActivityWithDates {
    ...
    pub calls_requested_feedback: Option<Vec<String>>,
    ...
    pub calls_received_feedback: Option<Vec<String>>,
    ...
    pub own_calls_listened_to: Option<Vec<String>>,
    ...
    pub others_calls_listened_to: Option<Vec<String>>,
    ...
    pub calls_shared_internally: Option<Vec<String>>,
    ...
    pub calls_shared_externally: Option<Vec<String>>,
    ...
    pub calls_attended: Option<Vec<String>>,
    ...
    pub calls_comments_given: Option<Vec<String>>,
    ...
    pub calls_comments_received: Option<Vec<String>>,
    ...
    pub calls_marked_as_feedback_given: Option<Vec<String>>,
    ...
    pub calls_marked_as_feedback_received: Option<Vec<String>>,
    ...
    pub calls_scorecards_filled: Option<Vec<String>>,
    ...
    pub calls_scorecards_received: Option<Vec<String>>,
...
impl DailyActivityWithDates {
    /// User daily activity
    pub fn new() -> DailyActivityWithDates {
