...
/// ExternalCrmPartyObject : External object associated with the party
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ExternalCrmPartyObject {
    ...
    pub fields: Option<Vec<models::CrmPartyContextField>>,
}

impl ExternalCrmPartyObject {
    /// External object associated with the party
    pub fn new(object_type: ObjectType, object_id: String) -> ExternalCrmPartyObject {
