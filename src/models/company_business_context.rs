...
/// CompanyBusinessContext : The company's details in an external system such as the CRM. If the domain is empty, to enable association, send the crmAccountId or crmOpportunityId
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CompanyBusinessContext {
...
impl CompanyBusinessContext {
    ...
    pub fn new(object_type: ObjectType, object_id: String) -> CompanyBusinessContext {
