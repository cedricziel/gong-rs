...
pub struct UsersDayByDayActivity {
    ...
    #[serde(rename = "usersDetailedActivities", skip_serializing_if = "Option::is_none")]
    pub users_detailed_activities: Option<Vec<models::UserDayByDayActivity>>,
}

impl UsersDayByDayActivity {
    pub fn new() -> UsersDayByDayActivity {
        UsersDayByDayActivity {
            request_id: None,
            records: None,
            users_detailed_activities: None,
        }
    }
}
