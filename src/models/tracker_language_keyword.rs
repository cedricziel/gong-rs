...
/// TrackerLanguageKeyword : The tracker keywords definition.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TrackerLanguageKeyword {
    ...
    #[serde(rename = "includeRelatedForms", skip_serializing_if = "Option::is_none")]
    pub include_related_forms: Option<bool>,
}

impl TrackerLanguageKeyword {
    /// The tracker keywords definition.
    pub fn new() -> TrackerLanguageKeyword {
        TrackerLanguageKeyword {
            language: None,
            keywords: None,
            include_related_forms: None,
        }
    }
}
