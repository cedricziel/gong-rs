...
/// LibraryFolderAccess : Library folder access permission.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LibraryFolderAccess {
    /// Library folder permission level - mandatory value.
    #[serde(rename = "permissionLevel", skip_serializing_if = "Option::is_none")]
    pub permission_level: Option<PermissionLevel>,
    /// List of library folder Ids, if set, \"permissionLevel\" must not be \"none\".
    #[serde(rename = "libraryFolderIds", skip_serializing_if = "Option::is_none")]
    pub library_folder_ids: Option<Vec<String>>,
    /// A user with this profile can manage public folder, if set, \"permissionLevel\" must not be \"none\".
    #[serde(rename = "managePublicFolder", skip_serializing_if = "Option::is_none")]
    pub manage_public_folder: Option<bool>,
    /// A user with this profile can manage streams, if set, \"permissionLevel\" must not be \"none\".
    #[serde(rename = "manageStreams", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "manageFolderCalls", skip_serializing_if = "Option::is_none")]
    pub manage_folder_calls: Option<bool>,
    ...
    #[serde(rename = "shareFoldersAndStreams", skip_serializing_if = "Option::is_none")]
    pub share_folders_and_streams: Option<bool>,
}

impl LibraryFolderAccess {
    /// Library folder access permission.
    pub fn new() -> LibraryFolderAccess {
        LibraryFolderAccess {
            permission_level: None,
            library_folder_ids: None,
            manage_public_folder: None,
            manage_streams: None,
            manage_folder_calls: None,
            share_folders_and_streams: None,
        }
    }
}
/// Library folder permission level - mandatory value.
...
pub enum PermissionLevel {
    ...
    #[serde(rename = "all")]
    All,
    #[serde(rename = "specific-folders")]
    SpecificFolders,
    #[serde(rename = "none, all, specific-folders")]
    NoneCommaAllCommaSpecificFolders,
}
