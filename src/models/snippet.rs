...
pub struct Snippet {
    ...
    #[serde(rename = "fromSec", skip_serializing_if = "Option::is_none")]
    pub from_sec: Option<i32>,
    ...
    #[serde(rename = "toSec", skip_serializing_if = "Option::is_none")]
    pub to_sec: Option<i32>,
}
