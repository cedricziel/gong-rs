...
pub struct CallsUsersAccessDeleteDto {
    ...
    pub call_access_list: Option<Vec<models::CallUsersAccessDto>>,
}

impl CallsUsersAccessDeleteDto {
    pub fn new() -> CallsUsersAccessDeleteDto {
