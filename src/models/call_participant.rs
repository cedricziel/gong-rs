...
/// CallParticipant : A list of the call's participants. A party must be provided for the primaryUser.
...
pub struct CallParticipant {
    ...
    #[serde(rename = "mediaChannelId", skip_serializing_if = "Option::is_none")]
    pub media_channel_id: Option<i32>,
    /// A list of links to external systems such as CRM, Telephony System, Case Management, etc.
    #[serde(rename = "context", skip_serializing_if = "Option::is_none")]
    pub context: Option<Vec<models::PartyUploadContext>>,
