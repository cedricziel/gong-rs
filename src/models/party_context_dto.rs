...
/// PartyContextDto : Links to external systems such as CRM, Dialer, Case Management etc
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PartyContextDto {
    ...
    pub objects: Option<Vec<models::ExternalPartyObject>>,
}

impl PartyContextDto {
    /// Links to external systems such as CRM, Dialer, Case Management etc
    pub fn new() -> PartyContextDto {
        PartyContextDto {
            system: None,
            objects: None,
        }
