...
/// DigitalInteractionRequest : Digital interaction metadata
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DigitalInteractionRequest {
...
impl DigitalInteractionRequest {
    /// Digital interaction metadata
    pub fn new(event_id: String, timestamp: String, event_type: String, content: models::Content, person: models::Person) -> DigitalInteractionRequest {
