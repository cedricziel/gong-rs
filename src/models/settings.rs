...
/// Settings : The user's settings in the Gong system.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct Settings {
    /// True if the team member is set to be recorded by Gong, false if not.
    #[serde(rename = "webConferencesRecorded", skip_serializing_if = "Option::is_none")]
    pub web_conferences_recorded: Option<bool>,
    ...
    #[serde(rename = "preventWebConferenceRecording", skip_serializing_if = "Option::is_none")]
    pub prevent_web_conference_recording: Option<bool>,
    /// True if the team member is set to import telephony calls from by Gong, false if not.
    #[serde(rename = "telephonyCallsImported", skip_serializing_if = "Option::is_none")]
    pub telephony_calls_imported: Option<bool>,
    /// True if the team member is set to import emails by Gong, false if not.
    #[serde(rename = "emailsImported", skip_serializing_if = "Option::is_none")]
    pub emails_imported: Option<bool>,
    /// True if the team member is set to prevent import of emails by Gong, false if not.
    #[serde(rename = "preventEmailImport", skip_serializing_if = "Option::is_none")]
    pub prevent_email_import: Option<bool>,
    /// True if the team member is set to import non recorded meetings by Gong, false if not.
    #[serde(rename = "nonRecordedMeetingsImported", skip_serializing_if = "Option::is_none")]
    pub non_recorded_meetings_imported: Option<bool>,
    /// True if the team member has Gong Connect enabled, false if not.
    #[serde(rename = "gongConnectEnabled", skip_serializing_if = "Option::is_none")]
    pub gong_connect_enabled: Option<bool>,
}
...
impl Settings {
    ...
    pub fn new() -> Settings {
        Settings {
            web_conferences_recorded: None,
            prevent_web_conference_recording: None,
            telephony_calls_imported: None,
            emails_imported: None,
            prevent_email_import: None,
            non_recorded_meetings_imported: None,
            gong_connect_enabled: None,
        }
    }
}
