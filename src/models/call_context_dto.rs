...
/// CallContextDto : Links to external systems such as CRM, Dialer, Case Management etc
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CallContextDto {
    ...
    pub objects: Option<Vec<models::ExternalCallObject>>,
}

impl CallContextDto {
    /// Links to external systems such as CRM, Dialer, Case Management etc
    pub fn new() -> CallContextDto {
        CallContextDto {
            system: None,
            objects: None,
        }
