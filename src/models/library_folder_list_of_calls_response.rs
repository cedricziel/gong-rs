...
pub struct LibraryFolderListOfCallsResponse {
    ...
    pub calls: Option<Vec<models::LibraryCall>>,
}

impl LibraryFolderListOfCallsResponse {
    pub fn new() -> LibraryFolderListOfCallsResponse {
