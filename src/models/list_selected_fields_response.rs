...
pub struct ListSelectedFieldsResponse {
    /// A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
    #[serde(rename = "requestId", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    /// selectedFields
    #[serde(rename = "objectTypeToSelectedFields", skip_serializing_if = "Option::is_none")]
    pub object_type_to_selected_fields: Option<std::collections::HashMap<String, Vec<models::GenericSchemaFieldRequest>>>,
}

impl ListSelectedFieldsResponse {
    pub fn new() -> ListSelectedFieldsResponse {
        ListSelectedFieldsResponse {
            request_id: None,
            object_type_to_selected_fields: None,
        }
    }
}
