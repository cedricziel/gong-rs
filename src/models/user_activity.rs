...
/// UserActivity : A list, in which each item specifies one user's activities.
...
pub struct UserActivity {
    ...
    #[serde(rename = "userAggregateActivityStats", skip_serializing_if = "Option::is_none")]
    pub user_aggregate_activity_stats: Option<Box<models::AggregateActivity>>,
}
...
impl UserActivity {
    ...
    pub fn new() -> UserActivity {
        UserActivity {
            ...
            user_aggregate_activity_stats: None,
        }
    }
}
