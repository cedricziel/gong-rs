...
pub struct CompanyUsersIntercationStatsResponse {
    ...
    #[serde(rename = "peopleInteractionStats", skip_serializing_if = "Option::is_none")]
    pub people_interaction_stats: Option<Vec<models::InteractionStats>>,
...
impl CompanyUsersIntercationStatsResponse {
    pub fn new() -> CompanyUsersIntercationStatsResponse {
        CompanyUsersIntercationStatsResponse {
            request_id: None,
            records: None,
            people_interaction_stats: None,
            time_zone: None,
            to_date_time: None,
            from_date_time: None,
        }
