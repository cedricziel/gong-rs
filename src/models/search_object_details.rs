...
/// SearchObjectDetails : The objects returned when searching for different content. For example, the companies or products being compared with one another, or 2nd party intent
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SearchObjectDetails {
...
impl SearchObjectDetails {
    ...
    pub fn new(name: String, object_type: ObjectType, domain: String) -> SearchObjectDetails {
        SearchObjectDetails {
            name,
            object_type,
            domain,
