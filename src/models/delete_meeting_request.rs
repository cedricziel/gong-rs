...
/// DeleteMeetingRequest : Meeting update metadata
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeleteMeetingRequest {
    /// The email address of the user who created the meeting.
    #[serde(rename = "organizerEmail", skip_serializing_if = "Option::is_none")]
    pub organizer_email: Option<String>,
}

impl DeleteMeetingRequest {
    /// Meeting update metadata
    pub fn new() -> DeleteMeetingRequest {
