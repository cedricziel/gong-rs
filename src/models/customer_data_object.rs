...
/// CustomerDataObject : List of objects in the external system.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CustomerDataObject {
    ...
    /// Crm Mirror ID.
    #[serde(rename = "mirrorId", skip_serializing_if = "Option::is_none")]
...
impl CustomerDataObject {
    /// List of objects in the external system.
    pub fn new() -> CustomerDataObject {
        CustomerDataObject {
            id: None,
            object_type: None,
            external_id: None,
