...
pub struct PublicApiAssignedFlow {
    ...
    #[serde(rename = "crmProspectId", skip_serializing_if = "Option::is_none")]
    pub crm_prospect_id: Option<String>,
    /// The newly created flow instance id.
    #[serde(rename = "flowInstanceId", skip_serializing_if = "Option::is_none")]
    pub flow_instance_id: Option<String>,
    /// The email address of the Gong user who owns the flow instance tasks.
    #[serde(rename = "flowInstanceOwnerEmail", skip_serializing_if = "Option::is_none")]
    pub flow_instance_owner_email: Option<String>,
    /// The full name of the Gong user who owns the flow instance tasks. 
    #[serde(rename = "flowInstanceOwnerFullName", skip_serializing_if = "Option::is_none")]
    pub flow_instance_owner_full_name: Option<String>,
    ...
    #[serde(rename = "flowInstanceCreateDate", skip_serializing_if = "Option::is_none")]
    pub flow_instance_create_date: Option<String>,
    /// The status of the flow instance.
    #[serde(rename = "flowInstanceStatus", skip_serializing_if = "Option::is_none")]
    pub flow_instance_status: Option<FlowInstanceStatus>,
...
impl PublicApiAssignedFlow {
    pub fn new() -> PublicApiAssignedFlow {
        PublicApiAssignedFlow {
            flow_id: None,
            flow_name: None,
            crm_prospect_id: None,
            flow_instance_id: None,
            flow_instance_owner_email: None,
            flow_instance_owner_full_name: None,
            flow_instance_create_date: None,
...
impl Default for FlowInstanceStatus {
    fn default() -> FlowInstanceStatus {
        Self::Running
    }
}
