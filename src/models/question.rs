...
/// Question : The questions in the scorecard.
...
pub struct Question {
    ...
    #[serde(rename = "questionRevisionId", skip_serializing_if = "Option::is_none")]
    pub question_revision_id: Option<i64>,
    /// The question's text.
    ...
    #[serde(rename = "answerGuide", skip_serializing_if = "Option::is_none")]
    pub answer_guide: Option<String>,
    ...
    pub answer_options: Option<Vec<models::QuestionOption>>,
}
