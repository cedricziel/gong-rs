...
pub struct CoachingMetrics {
    ...
    #[serde(rename = "coachingData", skip_serializing_if = "Option::is_none")]
    pub coaching_data: Option<Vec<models::CoachingMetricsData>>,
}

impl CoachingMetrics {
    pub fn new() -> CoachingMetrics {
        CoachingMetrics {
            request_id: None,
            coaching_data: None,
        }
