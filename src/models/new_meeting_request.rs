...
/// NewMeetingRequest : New meeting metadata
...
pub struct NewMeetingRequest {
    ...
    pub invitees: Vec<models::MeetingInvitee>,
...
impl NewMeetingRequest {
    /// New meeting metadata
    pub fn new(start_time: String, end_time: String, invitees: Vec<models::MeetingInvitee>, organizer_email: String) -> NewMeetingRequest {
        NewMeetingRequest {
            start_time,
            end_time,
            title: None,
