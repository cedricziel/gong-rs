...
/// ForecastEditSubmissions : User can edit forecasts submissions.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ForecastEditSubmissions {
...
impl ForecastEditSubmissions {
    /// User can edit forecasts submissions.
    pub fn new() -> ForecastEditSubmissions {
