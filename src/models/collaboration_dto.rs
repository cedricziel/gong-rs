...
/// CollaborationDto : Collaboration information added to the call
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CollaborationDto {
    /// A list of public comments.
    #[serde(rename = "publicComments", skip_serializing_if = "Option::is_none")]
    pub public_comments: Option<Vec<models::CommentDto>>,
}

impl CollaborationDto {
    /// Collaboration information added to the call
    pub fn new() -> CollaborationDto {
        CollaborationDto {
