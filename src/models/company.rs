...
/// Company : The company the person works in. Should include at least one of the following: domain, crmAccountId, crmOpportunityId (via the companyBusinessContext object)
...
pub struct Company {
    ...
    #[serde(rename = "companyBusinessContexts", skip_serializing_if = "Option::is_none")]
    pub company_business_contexts: Option<Vec<models::CompanyBusinessContext>>,
}
...
impl Company {
    ...
    pub fn new() -> Company {
        Company {
            ...
            name: None,
            domain: None,
            company_business_contexts: None,
        }
    }
}
