...
/// UpdateMeetingRequest : Meeting update metadata
...
impl UpdateMeetingRequest {
    ...
    pub fn new(start_time: String, end_time: String, invitees: Vec<models::MeetingInvitee>, organizer_email: String) -> UpdateMeetingRequest {
