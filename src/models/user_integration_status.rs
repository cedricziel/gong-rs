...
/// UserIntegrationStatus : The integration status for the request users
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserIntegrationStatus {
    ...
    #[serde(rename = "userFacingError", skip_serializing_if = "Option::is_none")]
    pub user_facing_error: Option<String>,
    /// A URL to place in the application to fix the problem
    #[serde(rename = "fixUrl", skip_serializing_if = "Option::is_none")]
...
impl UserIntegrationStatus {
    /// The integration status for the request users
    pub fn new() -> UserIntegrationStatus {
