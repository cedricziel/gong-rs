...
/// PersonBusinessContext : The person's details in an external system such as the CRM
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PersonBusinessContext {
...
impl PersonBusinessContext {
    /// The person's details in an external system such as the CRM
    pub fn new(object_type: ObjectType, object_id: String) -> PersonBusinessContext {
