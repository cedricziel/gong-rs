...
pub struct GetGenericCrmObjectsResponse {
    /// A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
    #[serde(rename = "requestId", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    /// crmObjects
    #[serde(rename = "crmObjectsMap", skip_serializing_if = "Option::is_none")]
    pub crm_objects_map: Option<std::collections::HashMap<String, std::collections::HashMap<String, serde_json::Value>>>,
}

impl GetGenericCrmObjectsResponse {
    pub fn new() -> GetGenericCrmObjectsResponse {
        GetGenericCrmObjectsResponse {
            request_id: None,
            crm_objects_map: None,
        }
    }
}
