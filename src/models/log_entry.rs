...
/// LogEntry : A list, in which each item specifies one log.
...
pub struct LogEntry {
    ...
    #[serde(rename = "impersonatorEmailAddress", skip_serializing_if = "Option::is_none")]
    pub impersonator_email_address: Option<String>,
    /// The full name of the impersonating user, if available.
    #[serde(rename = "impersonatorFullName", skip_serializing_if = "Option::is_none")]
    pub impersonator_full_name: Option<String>,
    /// Gong's unique numeric identifier for the impersonating user's company id (up to 20 digits), if available.
    #[serde(rename = "impersonatorCompanyId", skip_serializing_if = "Option::is_none")]
    pub impersonator_company_id: Option<String>,
    ...
    #[serde(rename = "logRecord", skip_serializing_if = "Option::is_none")]
    pub log_record: Option<std::collections::HashMap<String, serde_json::Value>>,
}
...
impl LogEntry {
    ...
    pub fn new() -> LogEntry {
        LogEntry {
            ...
            impersonator_email_address: None,
            impersonator_full_name: None,
            impersonator_company_id: None,
            event_time: None,
            log_record: None,
        }
    }
