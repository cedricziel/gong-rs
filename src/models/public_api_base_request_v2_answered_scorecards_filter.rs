...
pub struct PublicApiBaseRequestV2AnsweredScorecardsFilter {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<models::AnsweredScorecardsFilter>,
}

impl PublicApiBaseRequestV2AnsweredScorecardsFilter {
    pub fn new(filter: models::AnsweredScorecardsFilter) -> PublicApiBaseRequestV2AnsweredScorecardsFilter {
