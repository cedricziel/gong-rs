...
pub struct NewMeetingResponse {
    ...
    #[serde(rename = "additionalInvitees", skip_serializing_if = "Option::is_none")]
    pub additional_invitees: Option<Vec<models::MeetingInvitee>>,
}

impl NewMeetingResponse {
    pub fn new() -> NewMeetingResponse {
        NewMeetingResponse {
            request_id: None,
            meeting_id: None,
            meeting_url: None,
            additional_invitees: None,
        }
    }
}
