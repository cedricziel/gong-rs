...
/// SpeakersTimeline : The audio recording speech segments (who spoke when). Note that speakersTimeline and mediaChannelId are mutually exclusive, when providing speakersTimeline - mediaChannelId will not be used.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SpeakersTimeline {
    ...
    #[serde(rename = "speechSegments", skip_serializing_if = "Option::is_none")]
    pub speech_segments: Option<Vec<models::SpeechSegment>>,
}

impl SpeakersTimeline {
