...
/// CallAccessDetails : Call access details
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CallAccessDetails {
    /// Gong's unique numeric call ID.
    #[serde(rename = "callId", skip_serializing_if = "Option::is_none")]
    pub call_id: Option<String>,
    /// A list of users having access.
    #[serde(rename = "users", skip_serializing_if = "Option::is_none")]
    pub users: Option<Vec<models::UserAccessDetails>>,
}

impl CallAccessDetails {
    /// Call access details
    pub fn new() -> CallAccessDetails {
        CallAccessDetails {
            call_id: None,
            users: None,
        }
