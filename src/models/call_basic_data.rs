...
pub struct CallBasicData {
    ...
    #[serde(rename = "primaryUserId", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "sdrDisposition", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "clientUniqueId", skip_serializing_if = "Option::is_none")]
