...
/// UserSettingsHistory : User's settings history.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserSettingsHistory {
...
impl UserSettingsHistory {
    /// User's settings history.
    pub fn new() -> UserSettingsHistory {
        UserSettingsHistory {
            setting: None,
            value: None,
            time: None,
...
pub enum Setting {
    #[serde(rename = "webConferencesRecorded")]
    WebConferencesRecorded,
    #[serde(rename = "preventWebConferenceRecording")]
    PreventWebConferenceRecording,
    #[serde(rename = "emailsImported")]
    EmailsImported,
    #[serde(rename = "preventEmailImport")]
    PreventEmailImport,
    #[serde(rename = "active")]
    Active,
    #[serde(rename = "nonRecordedMeetingsImported")]
    NonRecordedMeetingsImported,
    #[serde(rename = "gongConnectEnabled")]
    GongConnectEnabled,
    #[serde(rename = "callsImported")]
    CallsImported,
    #[serde(rename = "interviewsRecorded")]
    InterviewsRecorded,
    #[serde(rename = "preventInterviewRecording")]
    PreventInterviewRecording,
}

impl Default for Setting {
    fn default() -> Setting {
        Self::WebConferencesRecorded
    }
}
