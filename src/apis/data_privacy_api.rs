...
/// struct for passing parameters to the method [`find_all_references_to_email_address`]
#[derive(Clone, Debug)]
pub struct FindAllReferencesToEmailAddressParams {
    /// The email address.
    pub email_address: String
}

/// struct for passing parameters to the method [`find_all_references_to_phone_number`]
#[derive(Clone, Debug)]
pub struct FindAllReferencesToPhoneNumberParams {
...
/// struct for passing parameters to the method [`purge_email_address`]
#[derive(Clone, Debug)]
pub struct PurgeEmailAddressParams {
    /// The email address.
    pub email_address: String
}

/// struct for passing parameters to the method [`purge_phone_number`]
#[derive(Clone, Debug)]
pub struct PurgePhoneNumberParams {
    /// The phone number.  This number must start with a + (plus) sign followed by the country code, area code, and local phone number. All other non-digits are ignored.  The following are examples of permitted phone numbers: +1 425 555 2671, +1-425-555-2671, +1 425 5552671, +14255552671, +1 425 555 26 71, +1(425) 555-2671, etc.  Note: This parameter should be URL-encoded.
    pub phone_number: String
}


/// struct for typed errors of method [`find_all_references_to_email_address`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FindAllReferencesToEmailAddressError {
...
/// struct for typed errors of method [`find_all_references_to_phone_number`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FindAllReferencesToPhoneNumberError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status429(models::ErrorResponse),
    Status500(models::ErrorResponse),
...
/// struct for typed errors of method [`purge_email_address`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PurgeEmailAddressError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status429(models::ErrorResponse),
    Status500(models::ErrorResponse),
...
/// struct for typed errors of method [`purge_phone_number`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PurgePhoneNumberError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status429(models::ErrorResponse),
    Status500(models::ErrorResponse),
...
pub async fn find_all_references_to_email_address(configuration: &configuration::Configuration, params: FindAllReferencesToEmailAddressParams) -> Result<models::EmailAddressReferences, Error<FindAllReferencesToEmailAddressError>> {
    ...
    let local_var_uri_str = format!("{}/v2/data-privacy/data-for-email-address", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FindAllReferencesToEmailAddressError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn find_all_references_to_phone_number(configuration: &configuration::Configuration, params: FindAllReferencesToPhoneNumberParams) -> Result<models::PhoneNumberReferences, Error<FindAllReferencesToPhoneNumberError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/data-privacy/data-for-phone-number", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    local_var_req_builder = local_var_req_builder.query(&[("phoneNumber", &phone_number.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    if let Some(ref local_var_auth_conf) = local_var_configuration.basic_auth {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FindAllReferencesToPhoneNumberError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn purge_email_address(configuration: &configuration::Configuration, params: PurgeEmailAddressParams) -> Result<models::BaseResponse, Error<PurgeEmailAddressError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/data-privacy/erase-data-for-email-address", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PurgeEmailAddressError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn purge_phone_number(configuration: &configuration::Configuration, params: PurgePhoneNumberParams) -> Result<models::BaseResponse, Error<PurgePhoneNumberError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/data-privacy/erase-data-for-phone-number", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PurgePhoneNumberError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
