...
/// struct for passing parameters to the method [`list_trackers`]
#[derive(Clone, Debug)]
pub struct ListTrackersParams {
    /// The ID of the workspace the keyword trackers are in. When empty, all trackers in all workspaces are returned.
    pub workspace_id: Option<String>
}


/// struct for typed errors of method [`list_scorecards`]
...
/// struct for typed errors of method [`list_trackers`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn list_scorecards(configuration: &configuration::Configuration) -> Result<models::Scorecards, Error<ListScorecardsError>> {
    ...
    let local_var_uri_str = format!("{}/v2/settings/scorecards", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListScorecardsError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn list_trackers(configuration: &configuration::Configuration, params: ListTrackersParams) -> Result<models::Trackers, Error<ListTrackersError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/settings/trackers", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListTrackersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_workspaces(configuration: &configuration::Configuration) -> Result<models::WorkspacesMetadata, Error<ListWorkspacesError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/workspaces", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
