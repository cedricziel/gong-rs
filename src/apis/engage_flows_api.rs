...
/// struct for passing parameters to the method [`assign_prospects`]
#[derive(Clone, Debug)]
pub struct AssignProspectsParams {
    pub assign_flow_request_v2: models::AssignFlowRequestV2
}

/// struct for passing parameters to the method [`get_flows_for_prospects`]
#[derive(Clone, Debug)]
pub struct GetFlowsForProspectsParams {
    pub prospects_assigned_flows_request_v2: models::ProspectsAssignedFlowsRequestV2
}

/// struct for passing parameters to the method [`list_flows`]
#[derive(Clone, Debug)]
pub struct ListFlowsParams {
    /// Email of the Gong user whose personal flows and flows shared with the user you want to return.
    pub flow_owner_email: String,
...
/// struct for typed errors of method [`assign_prospects`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AssignProspectsError {
...
/// struct for typed errors of method [`get_flows_for_prospects`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFlowsForProspectsError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status429(models::ErrorResponse),
    Status500(models::ErrorResponse),
...
pub async fn assign_prospects(configuration: &configuration::Configuration, params: AssignProspectsParams) -> Result<models::AssignFlowResponse, Error<AssignProspectsError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let assign_flow_request_v2 = params.assign_flow_request_v2;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/flows/prospects/assign", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&assign_flow_request_v2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssignProspectsError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_flows_for_prospects(configuration: &configuration::Configuration, params: GetFlowsForProspectsParams) -> Result<models::ProspectsFlowsResponse, Error<GetFlowsForProspectsError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let prospects_assigned_flows_request_v2 = params.prospects_assigned_flows_request_v2;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/flows/prospects", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&prospects_assigned_flows_request_v2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFlowsForProspectsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_flows(configuration: &configuration::Configuration, params: ListFlowsParams) -> Result<models::FlowsResponse, Error<ListFlowsError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let flow_owner_email = params.flow_owner_email;
    ...
    local_var_req_builder = local_var_req_builder.query(&[("flowOwnerEmail", &flow_owner_email.to_string())]);
