...
/// struct for passing parameters to the method [`content_shared`]
#[derive(Clone, Debug)]
pub struct ContentSharedParams {
    pub content_shared_event: models::ContentSharedEvent
}

/// struct for passing parameters to the method [`content_viewed`]
#[derive(Clone, Debug)]
pub struct ContentViewedParams {
    pub content_viewed_event: models::ContentViewedEvent
}

/// struct for passing parameters to the method [`custom_action`]
#[derive(Clone, Debug)]
pub struct CustomActionParams {
    pub custom_action_event: models::CustomActionEvent
}


/// struct for typed errors of method [`content_shared`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ContentSharedError {
...
/// struct for typed errors of method [`content_viewed`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ContentViewedError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status409(models::ErrorResponse),
    Status429(models::ErrorResponse),
...
/// struct for typed errors of method [`custom_action`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn content_shared(configuration: &configuration::Configuration, params: ContentSharedParams) -> Result<models::RegisterGenericCrmResponse, Error<ContentSharedError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let content_shared_event = params.content_shared_event;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/customer-engagement/content/shared", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&content_shared_event);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ContentSharedError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn content_viewed(configuration: &configuration::Configuration, params: ContentViewedParams) -> Result<models::RegisterGenericCrmResponse, Error<ContentViewedError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let content_viewed_event = params.content_viewed_event;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/customer-engagement/content/viewed", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&content_viewed_event);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ContentViewedError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn custom_action(configuration: &configuration::Configuration, params: CustomActionParams) -> Result<models::RegisterGenericCrmResponse, Error<CustomActionError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let custom_action_event = params.custom_action_event;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/customer-engagement/action", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&custom_action_event);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CustomActionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
