...
/// struct for passing parameters to the method [`list_answered_scorecards`]
#[derive(Clone, Debug)]
pub struct ListAnsweredScorecardsParams {
    pub public_api_base_request_v2_answered_scorecards_filter: models::PublicApiBaseRequestV2AnsweredScorecardsFilter
}

/// struct for passing parameters to the method [`list_interaction_stats`]
#[derive(Clone, Debug)]
pub struct ListInteractionStatsParams {
    pub public_api_base_request_v2_multiple_users_with_dates: models::PublicApiBaseRequestV2MultipleUsersWithDates
}

/// struct for passing parameters to the method [`list_multiple_users_aggregate_activity`]
#[derive(Clone, Debug)]
pub struct ListMultipleUsersAggregateActivityParams {
    pub public_api_base_request_v2_multiple_users_with_dates: models::PublicApiBaseRequestV2MultipleUsersWithDates
}

/// struct for passing parameters to the method [`list_multiple_users_aggregate_by_period`]
#[derive(Clone, Debug)]
pub struct ListMultipleUsersAggregateByPeriodParams {
    pub request_with_time_period: models::RequestWithTimePeriod
}

/// struct for passing parameters to the method [`list_multiple_users_day_by_day_activity`]
#[derive(Clone, Debug)]
pub struct ListMultipleUsersDayByDayActivityParams {
    pub public_api_base_request_v2_multiple_users_with_dates: models::PublicApiBaseRequestV2MultipleUsersWithDates
}


/// struct for typed errors of method [`list_answered_scorecards`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListAnsweredScorecardsError {
...
/// struct for typed errors of method [`list_interaction_stats`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListInteractionStatsError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status429(models::ErrorResponse),
...
/// struct for typed errors of method [`list_multiple_users_aggregate_activity`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListMultipleUsersAggregateActivityError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status429(models::ErrorResponse),
...
/// struct for typed errors of method [`list_multiple_users_aggregate_by_period`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListMultipleUsersAggregateByPeriodError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status429(models::ErrorResponse),
...
/// struct for typed errors of method [`list_multiple_users_day_by_day_activity`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListMultipleUsersDayByDayActivityError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status429(models::ErrorResponse),
...
pub async fn list_answered_scorecards(configuration: &configuration::Configuration, params: ListAnsweredScorecardsParams) -> Result<models::AnsweredScorecards, Error<ListAnsweredScorecardsError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let public_api_base_request_v2_answered_scorecards_filter = params.public_api_base_request_v2_answered_scorecards_filter;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/stats/activity/scorecards", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&public_api_base_request_v2_answered_scorecards_filter);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAnsweredScorecardsError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn list_interaction_stats(configuration: &configuration::Configuration, params: ListInteractionStatsParams) -> Result<models::CompanyUsersIntercationStatsResponse, Error<ListInteractionStatsError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let public_api_base_request_v2_multiple_users_with_dates = params.public_api_base_request_v2_multiple_users_with_dates;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/stats/interaction", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&public_api_base_request_v2_multiple_users_with_dates);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListInteractionStatsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_multiple_users_aggregate_activity(configuration: &configuration::Configuration, params: ListMultipleUsersAggregateActivityParams) -> Result<models::CompanyUsersAggregateActivityResponse, Error<ListMultipleUsersAggregateActivityError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/stats/activity/aggregate", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListMultipleUsersAggregateActivityError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_multiple_users_aggregate_by_period(configuration: &configuration::Configuration, params: ListMultipleUsersAggregateByPeriodParams) -> Result<models::UsersAggregateByPeriodActivity, Error<ListMultipleUsersAggregateByPeriodError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let request_with_time_period = params.request_with_time_period;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/stats/activity/aggregate-by-period", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&request_with_time_period);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListMultipleUsersAggregateByPeriodError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_multiple_users_day_by_day_activity(configuration: &configuration::Configuration, params: ListMultipleUsersDayByDayActivityParams) -> Result<models::UsersDayByDayActivity, Error<ListMultipleUsersDayByDayActivityError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/stats/activity/day-by-day", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListMultipleUsersDayByDayActivityError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
