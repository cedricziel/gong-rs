...
/// struct for passing parameters to the method [`add_meeting`]
#[derive(Clone, Debug)]
pub struct AddMeetingParams {
    pub new_meeting_request: models::NewMeetingRequest
}

/// struct for passing parameters to the method [`delete_meeting`]
#[derive(Clone, Debug)]
pub struct DeleteMeetingParams {
    /// Gong's unique identifier for the meeting (up to 20 digits).
    pub meeting_id: i64,
    pub delete_meeting_request: models::DeleteMeetingRequest
}

/// struct for passing parameters to the method [`integration_status`]
#[derive(Clone, Debug)]
pub struct IntegrationStatusParams {
    pub integration_status_request: models::IntegrationStatusRequest
}

/// struct for passing parameters to the method [`update_meeting`]
#[derive(Clone, Debug)]
pub struct UpdateMeetingParams {
    /// Gong's unique identifier for the meeting (up to 20 digits).
    pub meeting_id: i64,
    pub update_meeting_request: models::UpdateMeetingRequest
}


/// struct for typed errors of method [`add_meeting`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddMeetingError {
...
/// struct for typed errors of method [`delete_meeting`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`integration_status`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum IntegrationStatusError {
    Status400(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status429(models::ErrorResponse),
    Status500(models::ErrorResponse),
...
/// struct for typed errors of method [`update_meeting`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateMeetingError {
    Status400(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status409(models::ErrorResponse),
...
pub async fn add_meeting(configuration: &configuration::Configuration, params: AddMeetingParams) -> Result<models::NewMeetingResponse, Error<AddMeetingError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let new_meeting_request = params.new_meeting_request;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/meetings", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&new_meeting_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddMeetingError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_meeting(configuration: &configuration::Configuration, params: DeleteMeetingParams) -> Result<models::DeleteMeetingRequest, Error<DeleteMeetingError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let meeting_id = params.meeting_id;
    let delete_meeting_request = params.delete_meeting_request;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/meetings/{meetingId}", local_var_configuration.base_path, meetingId=meeting_id);
    ...
    local_var_req_builder = local_var_req_builder.json(&delete_meeting_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteMeetingError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn integration_status(configuration: &configuration::Configuration, params: IntegrationStatusParams) -> Result<models::IntegrationStatusResponse, Error<IntegrationStatusError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let integration_status_request = params.integration_status_request;


    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/meetings/integration/status", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&integration_status_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<IntegrationStatusError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_meeting(configuration: &configuration::Configuration, params: UpdateMeetingParams) -> Result<models::UpdateMeetingResponse, Error<UpdateMeetingError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let meeting_id = params.meeting_id;
    let update_meeting_request = params.update_meeting_request;
    ...
    local_var_req_builder = local_var_req_builder.json(&update_meeting_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateMeetingError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
