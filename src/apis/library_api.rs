...
/// struct for passing parameters to the method [`get_calls_in_specific_folder`]
#[derive(Clone, Debug)]
pub struct GetCallsInSpecificFolderParams {
    /// Gong's unique numeric identifier for the folder (up to 20 digits).
    pub folder_id: Option<String>
}

/// struct for passing parameters to the method [`get_library_structure`]
#[derive(Clone, Debug)]
pub struct GetLibraryStructureParams {
    /// Workspace identifier. We will retrieve folders which are related to this specific workspace.
    pub workspace_id: Option<String>
}


/// struct for typed errors of method [`get_calls_in_specific_folder`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetCallsInSpecificFolderError {
...
/// struct for typed errors of method [`get_library_structure`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetLibraryStructureError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status429(models::ErrorResponse),
...
pub async fn get_calls_in_specific_folder(configuration: &configuration::Configuration, params: GetCallsInSpecificFolderParams) -> Result<models::LibraryFolderListOfCallsResponse, Error<GetCallsInSpecificFolderError>> {
    ...
    let local_var_uri_str = format!("{}/v2/library/folder-content", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCallsInSpecificFolderError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_library_structure(configuration: &configuration::Configuration, params: GetLibraryStructureParams) -> Result<models::LibraryResponse, Error<GetLibraryStructureError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/library/folders", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLibraryStructureError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
