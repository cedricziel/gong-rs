...
/// struct for passing parameters to the method [`get_user_history`]
#[derive(Clone, Debug)]
pub struct GetUserHistoryParams {
    /// Gong's unique numeric identifier for the user (up to 20 digits).
    pub id: String
}

/// struct for passing parameters to the method [`list_multiple_users`]
#[derive(Clone, Debug)]
pub struct ListMultipleUsersParams {
    pub public_api_base_request_v2_multiple_users_request_with_creation_dates: models::PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates
}
...
pub async fn get_user(configuration: &configuration::Configuration, params: GetUserParams) -> Result<models::User, Error<GetUserError>> {
...
pub async fn get_user_history(configuration: &configuration::Configuration, params: GetUserHistoryParams) -> Result<models::SettingsHistory, Error<GetUserHistoryError>> {
    let local_var_configuration = configuration;
...
pub async fn list_multiple_users(configuration: &configuration::Configuration, params: ListMultipleUsersParams) -> Result<models::UsersMetadata, Error<ListMultipleUsersError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let public_api_base_request_v2_multiple_users_request_with_creation_dates = params.public_api_base_request_v2_multiple_users_request_with_creation_dates;
...
pub async fn list_users(configuration: &configuration::Configuration, params: ListUsersParams) -> Result<models::UsersMetadata, Error<ListUsersError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let cursor = params.cursor;
    let include_avatars = params.include_avatars;
