...
**users** | Option<[**Vec<models::UserSimpleMetadata>**](UserSimpleMetadata.md)> | A list, in which each item specifies a user attached to the permission profile. | [optional]
